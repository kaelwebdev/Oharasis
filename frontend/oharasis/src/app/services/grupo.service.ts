...
export class GrupoService {
  ...
  itemClt:AngularFirestoreCollection<Grupo>;
  item: Observable<Grupo[]>;
  itemDoc: AngularFirestoreDocument<Grupo>;
  collectionName:string= 'Grupos';
  ...
  constructor(public afs:AngularFirestore) {
   ...
   addItem(item:Grupo):Promise<boolean>{
   ...
   deleteItem(item:Grupo):Promise<boolean>{
   ...
   updateItem(item:Grupo):Promise<boolean>{
    this.itemDoc = this.afs.doc(`${this.collectionName}/${item.d_id}`);
